...
public class Bitdefender extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bitdefender);
        ...
        Button btnDownloadgoogleplay= (Button) findViewById(R.id.btn_downloadgoogleplay);
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://cafebazaar.ir/app/com.bitdefender.security/?l=fa"));
        ...
        btnDownloadgoogleplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.bitdefender.security"));
                startActivity(intent);
